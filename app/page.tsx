...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-4">
              <Link href="/login">
                <Button variant="outline" size="sm" className="bg-white text-zinc-900 border-zinc-300 hover:bg-zinc-100">
                  Masuk
                </Button>
              </Link>
              <Link href="/login">
            ...
            <div className="px-4 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <Link href="/login" className="flex-1">
                  <Button variant="outline" size="sm" className="w-full bg-white text-zinc-900 border-zinc-300 hover:bg-zinc-100">
                    Masuk
                  </Button>
                </Link>
                <Link href="/login" className="flex-1">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-zinc-900 tracking-tight mb-6">
              Nugas dengan AI,{" "}
              <span className="text-zinc-600">tidak ngegame</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/login">
                <Button size="lg" className="bg-zinc-900 text-white hover:bg-zinc-800 text-lg px-8 gap-2">
                  Mulai Gratis
                  <ChevronRight className="w-5 h-5" />
                </Button>
              </Link>
              <a href="#how-it-works">
                <Button size="lg" variant="outline" className="bg-white text-zinc-900 border-zinc-300 hover:bg-zinc-100 text-lg px-8">
                  Cara Kerja
                </Button>
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="p-6 rounded-xl bg-white border border-zinc-200 hover:border-zinc-300 hover:shadow-lg transition-all"
              >
                <div className="w-12 h-12 rounded-lg bg-zinc-100 text-zinc-700 flex items-center justify-center mb-4">
                  {feature.icon}
                </div>
      ...
      <section id="how-it-works" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {steps.map((step, index) => (
              <div key={index} className="text-center">
                <div className="w-16 h-16 rounded-full bg-zinc-900 text-white flex items-center justify-center text-2xl font-bold mb-6 mx-auto">
                  {step.number}
                </div>
          ...
          <div className="text-center mt-12">
            <Link href="/login">
              <Button size="lg" className="bg-zinc-900 text-white hover:bg-zinc-800 gap-2">
                Coba Sekarang
                <ChevronRight className="w-5 h-5" />
              </Button>
            </Link>
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((feature, fIndex) => (
                    <li key={fIndex} className="flex items-center gap-3 text-sm">
                      <CheckCircle2 className={`w-4 h-4 ${plan.highlight ? "text-zinc-400" : "text-zinc-700"}`} />
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-zinc-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/login">
            <Button size="lg" className="bg-white text-zinc-900 hover:bg-zinc-100 text-lg px-8 gap-2">
              Mulai Gratis
              <ChevronRight className="w-5 h-5" />
            </Button>
          </Link>
      ...
      <footer className="py-12 px-4 sm:px-6 lg:px-8 bg-zinc-950">
        <div className="max-w-7xl mx-auto">
